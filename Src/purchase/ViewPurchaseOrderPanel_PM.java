...
/**
 * Panel for Purchase Manager to view and search purchase orders, and see order details.
 * Provides a table with filtering and status options, and a detailed view dialog.
 * Uses a blue color theme for the UI elements.
 */
public class ViewPurchaseOrderPanel_PM extends JPanel {
     ...
     */
    public ViewPurchaseOrderPanel_PM() {
        ...
        ordersTable.setGridColor(new Color(180, 210, 255));
        ordersTable.setShowGrid(true);
        ordersTable.setSelectionBackground(new Color(180, 210, 255));
        ordersTable.setSelectionForeground(Color.BLACK);
        ordersTable.getTableHeader().setFont(new Font("Times New Roman", Font.BOLD, 13));
        ordersTable.getTableHeader().setBackground(new Color(200, 220, 250));
        ordersTable.getTableHeader().setForeground(new Color(30, 60, 120));

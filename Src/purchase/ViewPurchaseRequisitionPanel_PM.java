...
/**
 * Panel for Purchase Manager to view and search purchase requisitions, and see requisition details.
 * Provides a table with filtering and status options, and a detailed view dialog.
 * Uses a blue color theme for the UI elements.
 */
public class ViewPurchaseRequisitionPanel_PM extends JPanel {
     ...
     */
    public ViewPurchaseRequisitionPanel_PM() {
        ...
        /**
         * Custom renderer for status coloring and striped rows (blue theme).
        ...
        viewBtn.setBackground(new Color(225, 255, 240));

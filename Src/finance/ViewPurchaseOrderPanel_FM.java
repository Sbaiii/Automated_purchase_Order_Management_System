...
/**
 * Panel for Finance Manager to view and search purchase orders, and see order details.
 * Provides a table with filtering and status options, and a detailed view dialog.
 */
public class ViewPurchaseOrderPanel_FM extends JPanel {
     ...
     */
    public ViewPurchaseOrderPanel_FM() {
        ...
        /**
         * Custom renderer for striped rows (green theme) and status coloring.
         */

...
/**
 * Panel for Sales Manager to view and search purchase requisitions, and see requisition details.
 * Provides a table with filtering and status options, and a detailed view dialog.
 * Uses a red color theme for the UI elements.
 */
public class ViewPurchaseRequisitionPanel_SM extends JPanel {
     ...
     */
    public ViewPurchaseRequisitionPanel_SM() {
        ...
        String[] columnNames = {"RequisitionID", "ItemCode", "ItemName", "Quantity", "Date", "SupplierID", "RequestedBy", "Priority", "Remarks", "Status"};
        ...
        /**
         * Custom renderer for striped rows and status coloring (red theme).
        ...
        requisitionTable.setGridColor(new Color(255, 210, 210));
        requisitionTable.setShowGrid(true);
        requisitionTable.setSelectionBackground(new Color(255, 200, 200));
        ...
        requisitionTable.getTableHeader().setBackground(new Color(255, 210, 210));
        requisitionTable.getTableHeader().setForeground(new Color(120, 30, 30));
        ...
        viewBtn.addActionListener(_ -> {
            ...
            String[] fieldLabels = {"Requisition ID", "Item Code", "Item Name", "Quantity", "Date", "Supplier ID", "Requested By", "Priority", "Remarks", "Status"};

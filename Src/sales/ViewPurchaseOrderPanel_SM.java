...
/**
 * Panel for Sales Manager to view and search purchase orders, and see order details.
 * Provides a table with filtering and status options, and a detailed view dialog.
 * Uses a red color theme for the UI elements.
 */
public class ViewPurchaseOrderPanel_SM extends JPanel {
     ...
     * Initializes the panel with a search interface, status filter, and a table to display orders.
     */
    public ViewPurchaseOrderPanel_SM() {
        ...
        // Status filter dropdown for filtering orders by their status
        ...
        /**
         * Custom renderer for striped rows (red theme) and status coloring.
         * Provides visual distinction between different order statuses and alternating row colors.
         */
        class GreenStripedRowRenderer extends DefaultTableCellRenderer {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value,
                ...
                // Set text color for status column based on order status
                if (column == 10) {
                    switch (status) {
        ...
        ordersTable.setGridColor(new Color(255, 210, 210));
        ordersTable.setShowGrid(true);
        ordersTable.setSelectionBackground(new Color(255, 200, 200));
        ordersTable.setSelectionForeground(Color.BLACK);
        ordersTable.getTableHeader().setFont(new Font("Times New Roman", Font.BOLD, 13));
        ordersTable.getTableHeader().setBackground(new Color(255, 210, 210));
        ordersTable.getTableHeader().setForeground(new Color(120, 30, 30));
        ...
        viewBtn.addActionListener(_ -> {
            ...
            // Labels for the order details dialog
            ...
            cardPanel.setBackground(new Color(255, 235, 235));
            cardPanel.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createLineBorder(new Color(220, 120, 120), 2, true),
            ...
            cardTitle.setForeground(new Color(120, 30, 30));
            ...
            for (int i = 0; i < fieldLabels.length; i++) {
                ...
                nameLabel.setForeground(new Color(120, 30, 30));
                ...
                if (i == 10) { // Status column with color coding
